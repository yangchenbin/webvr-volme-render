...
THREE.VREffect = function ( renderer, onError ) {
	...
	this.render = function ( scene, camera, renderTarget, sceneBefore ) {
		...
		if ( vrDisplay && scope.isPresenting ) {
			...
			// }
			renderer.render( sceneBefore, cameraL, renderTarget, true );
			...
			// }
			renderer.render( sceneBefore, cameraR, renderTarget, true );
